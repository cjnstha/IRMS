...
<div class="x_panel">
  ...
  <div class="x_content">
    ...
    <form class="form-horizontal form-label-left" method="POST" action="{{route('complain.update',$complain->id)}}">
      {{csrf_field()}}
      <div class="form-group @if ($errors->has('children_id')) has-error @endif">
        ...
        <div class="col-md-6 col-sm-7 col-xs-12">
          <div class="control-group">
            <div class="controls">
              <input type="text" class="form-control" placeholder="Enter Children ID" name="children_id" autocomplete="false" value="{{$complain->children_id}}">
      ...
      <div class="form-group @if ($errors->has('vaccination_name')) has-error @endif">
        ...
        <div class="col-md-6 col-sm-7 col-xs-12">
          <div class="control-group">
            <div class="controls">
              <input type="text" class="form-control" placeholder="Enter Vaccination Name" name="vaccination_name" autocomplete="false" value="{{$complain->vaccination_name}}">
      ...
      <div class="form-group @if ($errors->has('vaccination_date')) has-error @endif">
        ...
        <div class="col-md-6 col-sm-7 col-xs-12">
          <div class="control-group dateTime">
            <div class="controls">
              <input type="text" name="vaccination_date" placeholder="Enter Vaccination Date" class="form-control has-feedback-left datepicker" data-date-format="mm/dd/yy" aria-describedby="" value="{{$complain->vaccination_date}}">
      ...
      <div class="form-group @if ($errors->has('vaccination_gap')) has-error @endif">
        ...
        <div class="col-md-6 col-sm-7 col-xs-12">
          <select class="form-control sumoselect" name="vaccination_gap" tabindex="-1">
            ...
            <option value="{{$vaccination_gap}}" @if($vaccination_gap == $complain->vaccination_gap) selected @endif>{{$vaccination_gap}}</option>
            @endforeach
          </select>
      ...
      <div class="form-group @if ($errors->has('issues')) has-error @endif">
        ...
        <div class="col-md-6 col-sm-7 col-xs-12">
          <div class="form-group">
            <textarea class="form-control" name="issues" cols="50" rows="10">{{$complain->issues}}</textarea>
