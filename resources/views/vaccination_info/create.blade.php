...
<div class="x_panel">
	...
	<div class="x_content">
		<form class="form-horizontal form-label-left" method="POST" action="{{route('vaccination.store')}}">
			{{csrf_field()}}
			<div class="form-group @if ($errors->has('vaccination_name')) has-error @endif">
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					<div class="control-group">
						<div class="controls">
							<input type="text" class="form-control" id="vacc_name" placeholder="Vaccination Name" name="vaccination_name">
			...
			<div class="form-group @if ($errors->has('purpose')) has-error @endif">
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					<div class="control-group">
						<div class="controls">
							<input type="text" class="form-control" placeholder="Purpose" name="purpose" autocomplete="false">
			...
			<div class="form-group @if ($errors->has('actual_date')) has-error @endif">
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					<div class="control-group">
						<div class="controls">
							<input class="form-control has-feedback-left datepicker" name="actual_date" type="text" value="">
			...
			<div class="form-group @if ($errors->has('vaccination_date')) has-error @endif">
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					<div class="control-group">
						<div class="controls">
							<input class="form-control has-feedback-left datepicker" name="vaccination_date" type="text" value="">
			...
			<div class="form-group @if ($errors->has('remark')) has-error @endif">
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					<div class="form-group">
						<textarea class="form-control" name="remark" cols="50" rows="10" ></textarea>
						...
						<ul>
							<li>
								<div class="radio-group">
									<input class="radio" id="radio-1" name="status" type="radio" value="Taken">
									<label for="radio-1" class="gender">Taken</label>  
								</div>
							</li>
							<li>
								<div class="radio-group">
									<input class="radio" id="radio-2" name="status" type="radio" value="Not Taken">
